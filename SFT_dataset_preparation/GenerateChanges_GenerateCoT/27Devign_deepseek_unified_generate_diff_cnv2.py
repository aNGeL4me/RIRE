...
if __name__ == "__main__":
    ...
    input_file = "train_512_InDevign_AddNewKeysCommitidProject_updated_target1target0_ChangesNull_DelIndent.json"
    output_file = "train_512_InDevign_AddNewKeysCommitidProject_updated_target1target0_ChangesNull_DelIndent_GenerateDiff.json"
    reasoning_content_file = "train_512_InDevign_AddNewKeysCommitidProject_updated_target1target0_ChangesNull_DelIndent_GenerateDiff_WithReason.json"
