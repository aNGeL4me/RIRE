...
def remove_leading_space(s):
    ...
    return s[0:] if s.startswith(' ') else s
...
def process_function_json(function_json_path, generated_patch):
    ...
    #     os.path.dirname(function_json_path),
    #     '013_' + os.path.basename(function_json_path)
    # )
    base_name = os.path.basename(function_json_path)
    name, ext = os.path.splitext(base_name)

    new_filename = f"{name}_UpdateChanges_2nd{ext}"
...
if __name__ == "__main__":
    ...
    #process_function_json('./test_40/train_512.json_InDiversevul_9103_changesNull_DelIndent_40Samples.json', './test_40/train_512.json_InDiversevul_9103_changesNull_DelIndent_40Samples_modified_reason_commit_patch.json')
    #process_function_json('./test2/012ChangesNull_modified_reason_commit_patch.json', './test_40/train_512.json_InDiversevul_9103_changesNull_DelIndent_40Samples_modified_reason_commit_patch.json')
    process_function_json(
        'train_512_InDiversevul_updateChanges_ChangesNull_DelIndent_UpdateChanges_1_ChangesNull.json', \
        'train_512_InDiversevul_AddNewKeysCommitidProjectEtc_updateProjectKeyValue_updateMessage_updateChanges_ChangesNull_DelIndent_GenerateDiff_patch.json')
