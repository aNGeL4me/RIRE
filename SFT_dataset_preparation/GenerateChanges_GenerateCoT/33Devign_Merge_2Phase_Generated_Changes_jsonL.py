...
update_changes_if_empty(\
    "train_512_InDevign_updated_target1_0_ChangesNull_UpdatedChanges_1.json", \
        "train_512_InDevign_updated_target1_0_ChangesNull_UpdatedChanges_1_ChangesNull_UpdateChanges_2nd.json", \
