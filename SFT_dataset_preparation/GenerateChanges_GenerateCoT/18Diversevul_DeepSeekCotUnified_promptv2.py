...
if __name__ == "__main__":
    ...
    input_file = "train_512_InDiversevul_updateChanges_DelIndent_GeneratedChanges_merged.json"
    changesmessages_file = "train_512_InDiversevul_updateChanges_DelIndent_GeneratedChanges_merged.json"
    output_file = "train_512_InDiversevul_updateChanges_DelIndent_GeneratedChanges_merged_result.json"
    reasoning_content_file = "train_512_InDiversevul_updateChanges_DelIndent_GeneratedChanges_merged_ReasonINCoT.json"
