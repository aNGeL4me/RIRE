...
# GitHub API authentication information (please use your valid token)
HEADERS = {
    "Accept": "application/vnd.github.v3+json",
    "Authorization": "token ghp_XXX",  # Please replace with your GitHub Token
...
def fetch_and_save_commits(urls, output_dir="commits20250310"):
    """Send GET request to URL and save JSON data locally"""
    for project, commit_id, url in urls:
        ...
        # Step 1: Check if the commit already exists. If it does, skip downloading its corresponding JSON file.
        if os.path.exists(output_file):
            print(f"Already exists, skipping: {output_file}")
            continue
        
        # Step 2: Only request download for commits that haven't been downloaded, to save time
        try:
...
if __name__ == "__main__":
    input_file = "function_formatted_target_1.json"
