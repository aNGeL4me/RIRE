...
def update_cleaned_json(cleaned_file, error_file, output_file):
    ...
    print(f"Update completed, {len(error_data)} entries updated, results saved to {output_file}")

# Example call
update_cleaned_json(
    cleaned_file="train512_22837_randomSampled3970_0x01_3reasons_cleaned.json",
    error_file="train512_22837_randomSampled3970_0x01_3reasons_error.json",
    output_file="train512_22837_randomSampled3970_0x01_3reasons_cleaned_updated_1st.json"
)
